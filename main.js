...
function gotMessage(message, sender, sendResponse) {
  if (message.text === "go") {
    ...
    if (
      ...
      console.log(todayDate !== storedDate ? "[Date NOK]" : "[Time NOK] Awaiting...");
    }
  }
}
  ...
  setTimeout(() => {
    ...
    */
    ...
    Array.from(tableRowEle).forEach((e, i) => {
      ...
      let coiCall = e.children[1].textContent.split(" ")[0].replaceAll(",", "");
      ...
      let coiPut = e.children[5].textContent.split(" ")[0].replaceAll(",", "");
